...
// General IO headers
#define PIN_OUT0_0  32 // ADC
#define PIN_OUT0_1  33 // ADC

#define PIN_OUT1_0  14 // ADC
#define PIN_OUT1_1  15 // ADC

#define PIN_OUT2_0  2  // ADC
#define PIN_OUT2_1  4  // ADC

#define PIN_DAC0_0  25 // ADC
#define PIN_DAC0_1  26 // ADC

#define PIN_IN0_0  34  // input only, ADC
#define PIN_IN0_1  35  // input only, ADC
