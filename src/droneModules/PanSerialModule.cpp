...
DEM_NAMESPACE* PanSerialModule::registerNamespace(DroneExecutionManager *dem) {
  // namespace for module type
  return dem->createNamespace(PAN_SERIAL_STR_PAN_SERIAL,0,true);
}

void PanSerialModule::registerParams(DEM_NAMESPACE* ns, DroneExecutionManager *dem) {
