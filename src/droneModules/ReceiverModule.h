...
// params
// @pub 10;u8;2;w;pins;Receiver input pins, one per receiver channel (see <a href="pins.html">Pin Mappings</a>) or a single pin for PPM
#define RECEIVER_PARAM_PINS         10
#define RECEIVER_PARAM_PINS_E       0

// @pub 11;f;1;r;value1;The output value on channel 1 (in range -1 .. 1)
#define RECEIVER_PARAM_VALUE1       11
#define RECEIVER_PARAM_VALUE1_E     1

// @pub 12;f;1;r;value2;The output value on channel 2 (in range -1 .. 1)
#define RECEIVER_PARAM_VALUE2       12
#define RECEIVER_PARAM_VALUE2_E     2

// @pub 13;f;1;r;value3;The output value on channel 3 (in range -1 .. 1)
#define RECEIVER_PARAM_VALUE3       13
#define RECEIVER_PARAM_VALUE3_E     3

// @pub 14;f;1;r;value4;The output value on channel 4 (in range -1 .. 1)
#define RECEIVER_PARAM_VALUE4       14
#define RECEIVER_PARAM_VALUE4_E     4

// @pub 15;f;1;r;value5;The output value on channel 5 (in range -1 .. 1)
#define RECEIVER_PARAM_VALUE5       15
#define RECEIVER_PARAM_VALUE5_E     5

// @pub 16;f;1;r;value6;The output value on channel 6 (in range -1 .. 1)
#define RECEIVER_PARAM_VALUE6       16
#define RECEIVER_PARAM_VALUE6_E     6

// @pub 19;u32;2;w;limits;The PWM timing min and max limits (default 1000 .. 2000)
#define RECEIVER_PARAM_LIMITS       19
#define RECEIVER_PARAM_LIMITS_E     7

// @pub 20;u8;6;r;input;Raw PWM timing input values for each channel divided by 10 (e.g. 2000us = 200)
#define RECEIVER_PARAM_INPUT        20
#define RECEIVER_PARAM_INPUT_E      8

// @pub 31;u8;1;w;mode;0=PWM, 1=PPM on first defined pin (Default PPM)
